...
public class PointIntegrationTest {
    ...
    public void 유저포인트_충전_실패() throws Exception {
        ...
        // when
        Exception exception = assertThrows(Exception.class, () -> pointService.chargeUserPoint(id, request));

        // then
        // 음수 포인트 충전으로 Exception 던짐.
    ...
    public void 유저포인트_사용_실패_많은포인트() throws Exception {
        ...
        // when
        Exception exception = assertThrows(Exception.class, () -> pointService.useUserPoint(5L, request));
